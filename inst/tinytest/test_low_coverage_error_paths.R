...
expect_error(
  prepare_concentration(input_xlsx = fixture, output = tempfile(fileext = ".tsv")),
  "concentration"
)
...
withr::with_tempdir({
  ...
  utils::write.table(data.frame(id = 1L, check.names = FALSE), feat_path,
